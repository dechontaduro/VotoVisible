    ...
    public class TwitterStream
    {
        ...
        public void Stream2Queue()
        {
            ...
            string postparameters = 
                (ConfigurationManager.AppSettings["track_keywords"].Length == 0 ? string.Empty : "&track=" + ConfigurationManager.AppSettings["track_keywords"]) +
        ...
        public void MessageProcess(object objMessage)
        {
            ...
            try
            {
                ...
                if (log.IsInfoEnabled) log.InfoFormat("Msg:{1}", message.Body.ToString());
                ...
                //if (log.IsInfoEnabled) log.InfoFormat("Msg:{1}", status);
